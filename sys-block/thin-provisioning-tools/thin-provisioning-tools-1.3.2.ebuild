...
SRC_URI="
https://api.github.com/repos/jthornber/thin-provisioning-tools/tarball/refs/tags/v1.3.2 -> thin-provisioning-tools-1.3.2-c4deeda.tar.gz
mirror://macaroni/thin-provisioning-tools-1.3.2-mark-rust-bundle-c4deeda.tar.xz -> thin-provisioning-tools-1.3.2-mark-rust-bundle-c4deeda.tar.xz"
LICENSE="GPL-3.0"
SLOT="0"
KEYWORDS="*"
DOCS=(
