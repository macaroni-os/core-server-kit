...
SRC_URI="
https://api.github.com/repos/jthornber/thin-provisioning-tools/tarball/refs/tags/v1.3.4 -> thin-provisioning-tools-1.3.4-b4db833.tar.gz
mirror://macaroni/thin-provisioning-tools-1.3.4-mark-rust-bundle-b4db833.tar.xz -> thin-provisioning-tools-1.3.4-mark-rust-bundle-b4db833.tar.xz"
LICENSE="GPL-3.0"
SLOT="0"
KEYWORDS="*"
DOCS=(
