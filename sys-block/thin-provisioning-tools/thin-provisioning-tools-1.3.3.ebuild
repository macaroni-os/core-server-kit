...
SRC_URI="
https://api.github.com/repos/jthornber/thin-provisioning-tools/tarball/refs/tags/v1.3.3 -> thin-provisioning-tools-1.3.3-b61de42.tar.gz
mirror://macaroni/thin-provisioning-tools-1.3.3-mark-rust-bundle-b61de42.tar.xz -> thin-provisioning-tools-1.3.3-mark-rust-bundle-b61de42.tar.xz"
LICENSE="GPL-3.0"
SLOT="0"
KEYWORDS="*"
DOCS=(
