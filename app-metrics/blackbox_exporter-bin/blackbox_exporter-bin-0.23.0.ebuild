...
SRC_URI="
	amd64? ( https://github.com/prometheus/blackbox_exporter/releases/download/v0.23.0/blackbox_exporter-0.23.0.linux-amd64.tar.gz -> blackbox_exporter-0.23.0.linux-amd64.tar.gz )
	arm64? ( https://github.com/prometheus/blackbox_exporter/releases/download/v0.23.0/blackbox_exporter-0.23.0.linux-arm64.tar.gz -> blackbox_exporter-0.23.0.linux-arm64.tar.gz )"
