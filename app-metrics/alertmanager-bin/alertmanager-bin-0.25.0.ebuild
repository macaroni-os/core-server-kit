...
SRC_URI="
	amd64? ( https://github.com/prometheus/alertmanager/releases/download/v0.25.0/alertmanager-0.25.0.linux-amd64.tar.gz -> alertmanager-0.25.0.linux-amd64.tar.gz )
	arm64? ( https://github.com/prometheus/alertmanager/releases/download/v0.25.0/alertmanager-0.25.0.linux-arm64.tar.gz -> alertmanager-0.25.0.linux-arm64.tar.gz )"
