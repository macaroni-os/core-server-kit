...
SRC_URI="amd64? (
  https://github.com/prometheus/memcached_exporter/releases/download/v0.15.2/memcached_exporter-0.15.2.linux-amd64.tar.gz -> memcached_exporter-0.15.2.linux-amd64.tar.gz
)
arm64? (
  https://github.com/prometheus/memcached_exporter/releases/download/v0.15.2/memcached_exporter-0.15.2.linux-arm64.tar.gz -> memcached_exporter-0.15.2.linux-arm64.tar.gz
)
"
