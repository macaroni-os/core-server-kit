...
SRC_URI="
amd64? ( https://github.com/prometheus/memcached_exporter/releases/download/v0.17.0/memcached_exporter-0.17.0.linux-amd64.tar.gz -> memcached_exporter-bin-0.17.0.linux-amd64.tar.gz )
arm64? ( https://github.com/prometheus/memcached_exporter/releases/download/v0.17.0/memcached_exporter-0.17.0.linux-arm64.tar.gz -> memcached_exporter-bin-0.17.0.linux-arm64.tar.gz )"
LICENSE="Apache-2.0"
SLOT="0"
KEYWORDS="*"
IUSE="amd64 arm64"
