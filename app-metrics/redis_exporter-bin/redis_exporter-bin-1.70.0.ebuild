...
SRC_URI="
amd64? ( https://github.com/oliver006/redis_exporter/releases/download/v1.70.0/redis_exporter-v1.70.0.linux-amd64.tar.gz -> redis_exporter-bin-1.70.0.linux-amd64.tar.gz )
arm64? ( https://github.com/oliver006/redis_exporter/releases/download/v1.70.0/redis_exporter-v1.70.0.linux-arm64.tar.gz -> redis_exporter-bin-1.70.0.linux-arm64.tar.gz )"
LICENSE="Apache-2.0"
SLOT="0"
KEYWORDS="*"
IUSE="amd64 arm64"
