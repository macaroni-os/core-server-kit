...
SRC_URI="https://github.com/oliver006/redis_exporter/releases/download/v1.36.0/redis_exporter-v1.36.0.linux-amd64.tar.gz -> redis_exporter-v1.36.0.linux-amd64.tar.gz"
