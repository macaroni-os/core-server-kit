...
SRC_URI="
	amd64? ( https://github.com/oliver006/redis_exporter/releases/download/v1.53.0/redis_exporter-v1.53.0.linux-amd64.tar.gz -> redis_exporter-v1.53.0.linux-amd64.tar.gz )
	arm64? ( https://github.com/oliver006/redis_exporter/releases/download/v1.53.0/redis_exporter-v1.53.0.linux-arm64.tar.gz -> redis_exporter-v1.53.0.linux-arm64.tar.gz )"
