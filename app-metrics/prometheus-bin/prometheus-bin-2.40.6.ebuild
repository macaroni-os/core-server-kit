...
SRC_URI="
	amd64? ( https://github.com/prometheus/prometheus/releases/download/v2.40.6/prometheus-2.40.6.linux-amd64.tar.gz -> prometheus-2.40.6.linux-amd64.tar.gz )
	arm64? ( https://github.com/prometheus/prometheus/releases/download/v2.40.6/prometheus-2.40.6.linux-arm64.tar.gz -> prometheus-2.40.6.linux-arm64.tar.gz )"
