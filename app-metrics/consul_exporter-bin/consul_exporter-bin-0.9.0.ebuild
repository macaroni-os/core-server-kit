...
SRC_URI="
	amd64? ( https://github.com/prometheus/consul_exporter/releases/download/v0.9.0/consul_exporter-0.9.0.linux-amd64.tar.gz -> consul_exporter-0.9.0.linux-amd64.tar.gz )
	arm64? ( https://github.com/prometheus/consul_exporter/releases/download/v0.9.0/consul_exporter-0.9.0.linux-arm64.tar.gz -> consul_exporter-0.9.0.linux-arm64.tar.gz )"
