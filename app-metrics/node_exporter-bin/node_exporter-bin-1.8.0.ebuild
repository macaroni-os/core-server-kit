...
SRC_URI="
	amd64? ( https://github.com/prometheus/node_exporter/releases/download/v1.8.0/node_exporter-1.8.0.linux-amd64.tar.gz -> node_exporter-1.8.0.linux-amd64.tar.gz )
	arm64? ( https://github.com/prometheus/node_exporter/releases/download/v1.8.0/node_exporter-1.8.0.linux-arm64.tar.gz -> node_exporter-1.8.0.linux-arm64.tar.gz )"
