...
SRC_URI="
https://api.github.com/repos/fish-shell/fish-shell/tarball/4.6.0 -> fish-4.6.0-c7ecc3b.tar.gz
mirror://macaroni/fish-4.6.0-mark-rust-bundle-c7ecc3b.tar.xz -> fish-4.6.0-mark-rust-bundle-c7ecc3b.tar.xz"
LICENSE="GPL-2"
SLOT="0"
KEYWORDS="*"
IUSE="nls"
...
src_configure() {
	export FISH_BUILD_VERSION="4.6.0-c7ecc3b"
	local mycmakeargs=(
