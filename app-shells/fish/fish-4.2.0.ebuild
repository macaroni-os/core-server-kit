...
SRC_URI="
https://api.github.com/repos/fish-shell/fish-shell/tarball/4.2.0 -> fish-4.2.0-896f060.tar.gz
mirror://macaroni/fish-4.2.0-mark-rust-bundle-896f060.tar.xz -> fish-4.2.0-mark-rust-bundle-896f060.tar.xz"
LICENSE="GPL-2"
SLOT="0"
KEYWORDS="*"
IUSE="nls"
...
src_configure() {
	export FISH_BUILD_VERSION="4.2.0-896f060"
	local mycmakeargs=(
