...
SRC_URI="
https://api.github.com/repos/fish-shell/fish-shell/tarball/4.1.2 -> fish-4.1.2-3fa2526.tar.gz
mirror://macaroni/fish-4.1.2-mark-rust-bundle-3fa2526.tar.xz -> fish-4.1.2-mark-rust-bundle-3fa2526.tar.xz"
LICENSE="GPL-2"
SLOT="0"
KEYWORDS="*"
IUSE="nls"
...
src_configure() {
	export FISH_BUILD_VERSION="4.1.2-3fa2526"
	local mycmakeargs=(
