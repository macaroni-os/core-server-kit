...
SRC_URI="
https://api.github.com/repos/fish-shell/fish-shell/tarball/4.3.2 -> fish-4.3.2-c5bc7bd.tar.gz
mirror://macaroni/fish-4.3.2-mark-rust-bundle-c5bc7bd.tar.xz -> fish-4.3.2-mark-rust-bundle-c5bc7bd.tar.xz"
LICENSE="GPL-2"
SLOT="0"
KEYWORDS="*"
IUSE="nls"
...
src_configure() {
	export FISH_BUILD_VERSION="4.3.2-c5bc7bd"
	local mycmakeargs=(
