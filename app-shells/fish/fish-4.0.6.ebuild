...
SRC_URI="
https://api.github.com/repos/fish-shell/fish-shell/tarball/4.0.6 -> fish-4.0.6-7619fa3.tar.gz
mirror://macaroni/fish-4.0.6-mark-rust-bundle-7619fa3.tar.xz -> fish-4.0.6-mark-rust-bundle-7619fa3.tar.xz"
LICENSE="GPL-2"
SLOT="0"
KEYWORDS="*"
PATCHES=(
...
src_configure() {
	export FISH_BUILD_VERSION="4.0.6-7619fa3"
	local mycmakeargs=(
