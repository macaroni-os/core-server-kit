...
SRC_URI="
https://api.github.com/repos/fish-shell/fish-shell/tarball/4.0.2 -> fish-4.0.2-f1456f9.tar.gz
mirror://macaroni/fish-4.0.2-mark-rust-bundle-f1456f9.tar.xz -> fish-4.0.2-mark-rust-bundle-f1456f9.tar.xz"
LICENSE="GPL-2"
SLOT="0"
KEYWORDS="*"
PATCHES=(
...
src_configure() {
	export FISH_BUILD_VERSION="4.0.2-f1456f9"
	local mycmakeargs=(
