...
SRC_URI="
https://api.github.com/repos/fish-shell/fish-shell/tarball/4.1.1 -> fish-4.1.1-1f6cd5f.tar.gz
mirror://macaroni/fish-4.1.1-mark-rust-bundle-1f6cd5f.tar.xz -> fish-4.1.1-mark-rust-bundle-1f6cd5f.tar.xz"
LICENSE="GPL-2"
SLOT="0"
KEYWORDS="*"
IUSE="nls"
...
src_configure() {
	export FISH_BUILD_VERSION="4.1.1-1f6cd5f"
	local mycmakeargs=(
