...
SRC_URI="
https://api.github.com/repos/fish-shell/fish-shell/tarball/4.5.0 -> fish-4.5.0-3478f78.tar.gz
mirror://macaroni/fish-4.5.0-mark-rust-bundle-3478f78.tar.xz -> fish-4.5.0-mark-rust-bundle-3478f78.tar.xz"
LICENSE="GPL-2"
SLOT="0"
KEYWORDS="*"
IUSE="nls"
...
src_configure() {
	export FISH_BUILD_VERSION="4.5.0-3478f78"
	local mycmakeargs=(
