...
SRC_URI="
https://api.github.com/repos/fish-shell/fish-shell/tarball/4.4.0 -> fish-4.4.0-e1a0df6.tar.gz
mirror://macaroni/fish-4.4.0-mark-rust-bundle-e1a0df6.tar.xz -> fish-4.4.0-mark-rust-bundle-e1a0df6.tar.xz"
LICENSE="GPL-2"
SLOT="0"
KEYWORDS="*"
IUSE="nls"
...
src_configure() {
	export FISH_BUILD_VERSION="4.4.0-e1a0df6"
	local mycmakeargs=(
