...
SRC_URI="
https://api.github.com/repos/fish-shell/fish-shell/tarball/4.3.3 -> fish-4.3.3-c98fd88.tar.gz
mirror://macaroni/fish-4.3.3-mark-rust-bundle-c98fd88.tar.xz -> fish-4.3.3-mark-rust-bundle-c98fd88.tar.xz"
LICENSE="GPL-2"
SLOT="0"
KEYWORDS="*"
IUSE="nls"
...
src_configure() {
	export FISH_BUILD_VERSION="4.3.3-c98fd88"
	local mycmakeargs=(
