...
SRC_URI="
https://api.github.com/repos/fish-shell/fish-shell/tarball/4.2.1 -> fish-4.2.1-3bc896b.tar.gz
mirror://macaroni/fish-4.2.1-mark-rust-bundle-3bc896b.tar.xz -> fish-4.2.1-mark-rust-bundle-3bc896b.tar.xz"
LICENSE="GPL-2"
SLOT="0"
KEYWORDS="*"
IUSE="nls"
...
src_configure() {
	export FISH_BUILD_VERSION="4.2.1-3bc896b"
	local mycmakeargs=(
