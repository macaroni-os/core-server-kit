...
SRC_URI="
https://api.github.com/repos/junegunn/fzf/tarball/v0.74.3 -> fzf-0.74.3-15f64c4.tar.gz
mirror://macaroni/fzf-0.74.3-mark-go-bundle-15f64c4.tar.xz -> fzf-0.74.3-mark-go-bundle-15f64c4.tar.xz"
LICENSE="MIT"
SLOT="0"
KEYWORDS="*"
BDEPEND="dev-lang/go
