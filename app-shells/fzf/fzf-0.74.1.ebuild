...
SRC_URI="
https://api.github.com/repos/junegunn/fzf/tarball/v0.74.1 -> fzf-0.74.1-eae8d9d.tar.gz
mirror://macaroni/fzf-0.74.1-mark-go-bundle-eae8d9d.tar.xz -> fzf-0.74.1-mark-go-bundle-eae8d9d.tar.xz"
LICENSE="MIT"
SLOT="0"
KEYWORDS="*"
BDEPEND="dev-lang/go
