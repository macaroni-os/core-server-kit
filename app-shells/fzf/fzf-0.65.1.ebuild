...
SRC_URI="
https://api.github.com/repos/junegunn/fzf/tarball/v0.65.1 -> fzf-0.65.1-e5cd7f0.tar.gz
mirror://macaroni/fzf-0.65.1-mark-go-bundle-e5cd7f0.tar.xz -> fzf-0.65.1-mark-go-bundle-e5cd7f0.tar.xz"
LICENSE="MIT"
SLOT="0"
KEYWORDS="*"
BDEPEND="dev-lang/go
