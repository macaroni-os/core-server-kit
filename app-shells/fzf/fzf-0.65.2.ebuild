...
SRC_URI="
https://api.github.com/repos/junegunn/fzf/tarball/v0.65.2 -> fzf-0.65.2-416aff8.tar.gz
mirror://macaroni/fzf-0.65.2-mark-go-bundle-416aff8.tar.xz -> fzf-0.65.2-mark-go-bundle-416aff8.tar.xz"
LICENSE="MIT"
SLOT="0"
KEYWORDS="*"
BDEPEND="dev-lang/go
