...
SRC_URI="
https://api.github.com/repos/junegunn/fzf/tarball/v0.72.0 -> fzf-0.72.0-6fefe02.tar.gz
mirror://macaroni/fzf-0.72.0-mark-go-bundle-6fefe02.tar.xz -> fzf-0.72.0-mark-go-bundle-6fefe02.tar.xz"
LICENSE="MIT"
SLOT="0"
KEYWORDS="*"
BDEPEND="dev-lang/go
