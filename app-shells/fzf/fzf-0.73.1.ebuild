...
SRC_URI="
https://api.github.com/repos/junegunn/fzf/tarball/v0.73.1 -> fzf-0.73.1-ce4bef7.tar.gz
mirror://macaroni/fzf-0.73.1-mark-go-bundle-ce4bef7.tar.xz -> fzf-0.73.1-mark-go-bundle-ce4bef7.tar.xz"
LICENSE="MIT"
SLOT="0"
KEYWORDS="*"
BDEPEND="dev-lang/go
