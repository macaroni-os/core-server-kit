...
SRC_URI="
https://api.github.com/repos/junegunn/fzf/tarball/v0.74.2 -> fzf-0.74.2-3337be9.tar.gz
mirror://macaroni/fzf-0.74.2-mark-go-bundle-3337be9.tar.xz -> fzf-0.74.2-mark-go-bundle-3337be9.tar.xz"
LICENSE="MIT"
SLOT="0"
KEYWORDS="*"
BDEPEND="dev-lang/go
