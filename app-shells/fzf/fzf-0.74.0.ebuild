...
SRC_URI="
https://api.github.com/repos/junegunn/fzf/tarball/v0.74.0 -> fzf-0.74.0-6765f46.tar.gz
mirror://macaroni/fzf-0.74.0-mark-go-bundle-6765f46.tar.xz -> fzf-0.74.0-mark-go-bundle-6765f46.tar.xz"
LICENSE="MIT"
SLOT="0"
KEYWORDS="*"
BDEPEND="dev-lang/go
