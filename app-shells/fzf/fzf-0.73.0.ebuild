...
SRC_URI="
https://api.github.com/repos/junegunn/fzf/tarball/v0.73.0 -> fzf-0.73.0-a24deef.tar.gz
mirror://macaroni/fzf-0.73.0-mark-go-bundle-a24deef.tar.xz -> fzf-0.73.0-mark-go-bundle-a24deef.tar.xz"
LICENSE="MIT"
SLOT="0"
KEYWORDS="*"
BDEPEND="dev-lang/go
