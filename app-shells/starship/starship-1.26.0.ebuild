...
SRC_URI="
https://api.github.com/repos/starship/starship/tarball/v1.26.0 -> starship-1.26.0-fca92d8.tar.gz
mirror://macaroni/starship-1.26.0-mark-rust-bundle-fca92d8.tar.xz -> starship-1.26.0-mark-rust-bundle-fca92d8.tar.xz"
LICENSE="ISC"
SLOT="0"
KEYWORDS="*"
DOCS=(
