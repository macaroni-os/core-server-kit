...
SRC_URI="
https://api.github.com/repos/starship/starship/tarball/v1.24.1 -> starship-1.24.1-378f3e4.tar.gz
mirror://macaroni/starship-1.24.1-mark-rust-bundle-378f3e4.tar.xz -> starship-1.24.1-mark-rust-bundle-378f3e4.tar.xz"
LICENSE="ISC"
SLOT="0"
KEYWORDS="*"
DOCS=(
