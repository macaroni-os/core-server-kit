...
SRC_URI="https://archive.mariadb.org/connector-c-3.4.9/mariadb-connector-c-3.4.9-src.tar.gz -> mariadb-connector-c-3.4.9.tar.gz"
LICENSE="LGPL-2.1+"
SLOT="0/3"
KEYWORDS="*"
PATCHES=(
...
DEPEND="${RDEPEND}
"
S="${WORKDIR}/mariadb-connector-c-3.4.9-src"
src_prepare() {
	cmake_src_prepare
