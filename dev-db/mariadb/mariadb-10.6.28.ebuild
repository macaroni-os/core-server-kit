...
SRC_URI="https://archive.mariadb.org/mariadb-10.6.28/source/mariadb-10.6.28.tar.gz -> mariadb-10.6.28.tar.gz"
...
src_configure() {
	...
	mycmakeargs=(
	  ...
	  -DWITH_COMMENT="MacaroniOS Linux mariadb-10.6.28"
...
pkg_config() {
	whip h mariadb.config --enable-stdin || die "Error on configure ${P}"
}
