...
SRC_URI="
	amd64? ( https://artifacts.elastic.co/downloads/logstash/logstash-7.17.8-linux-x86_64.tar.gz -> logstash-7.17.8-linux-x86_64.tar.gz )

	arm64? ( https://artifacts.elastic.co/downloads/logstash/logstash-7.17.8-linux-aarch64.tar.gz -> logstash-7.17.8-linux-aarch64.tar.gz )
"
