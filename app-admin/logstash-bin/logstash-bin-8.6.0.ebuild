...
SRC_URI="
	amd64? ( https://artifacts.elastic.co/downloads/logstash/logstash-8.6.0-linux-x86_64.tar.gz -> logstash-8.6.0-linux-x86_64.tar.gz )

	arm64? ( https://artifacts.elastic.co/downloads/logstash/logstash-8.6.0-linux-aarch64.tar.gz -> logstash-8.6.0-linux-aarch64.tar.gz )
"
