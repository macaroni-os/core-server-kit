...
SRC_URI="
	amd64? ( https://artifacts.elastic.co/downloads/logstash/logstash-8.5.3-linux-x86_64.tar.gz -> logstash-8.5.3-linux-x86_64.tar.gz )

	arm64? ( https://artifacts.elastic.co/downloads/logstash/logstash-8.5.3-linux-aarch64.tar.gz -> logstash-8.5.3-linux-aarch64.tar.gz )
"
