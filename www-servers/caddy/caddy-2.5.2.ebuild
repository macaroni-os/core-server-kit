...
EGO_SUM=(
	...
	"github.com/google/cel-go v0.11.4/go.mod"
	...
	"github.com/klauspost/cpuid/v2 v2.0.13/go.mod"
	...
	"github.com/lucas-clemente/quic-go v0.28.0/go.mod"
	...
	"github.com/smallstep/certificates v0.18.0/go.mod"
	"github.com/smallstep/certificates v0.19.0"
	"github.com/smallstep/certificates v0.19.0/go.mod"
	"github.com/smallstep/certinfo v1.5.2/go.mod"
	"github.com/smallstep/cli v0.18.0"
	"github.com/smallstep/cli v0.18.0/go.mod"
	"github.com/smallstep/nosql v0.3.9/go.mod"
	...
	"github.com/smallstep/truststore v0.11.0/go.mod"
	...
	"go.step.sm/crypto v0.13.0/go.mod"
	"go.step.sm/crypto v0.16.1"
	"go.step.sm/crypto v0.16.1/go.mod"
	"go.step.sm/linkedca v0.7.0/go.mod"
	"go.step.sm/linkedca v0.15.0"
	"go.step.sm/linkedca v0.15.0/go.mod"
...
SRC_URI="https://github.com/caddyserver/caddy/archive/v2.5.2.tar.gz -> caddy-v2.5.2.tar.gz
	${EGO_SUM_SRC_URI}"
