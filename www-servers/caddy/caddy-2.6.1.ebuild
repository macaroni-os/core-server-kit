...
EGO_SUM=(
	...
	"cloud.google.com/go/security v1.3.0/go.mod"
	...
	"github.com/Azure/azure-sdk-for-go v58.0.0+incompatible/go.mod"
	...
	"github.com/antlr/antlr4/runtime/Go/antlr v0.0.0-20220418222510-f25a4f6275ed/go.mod"
	...
	"github.com/caddyserver/certmagic v0.17.1/go.mod"
	...
	"github.com/cyberdelia/go-metrics-graphite v0.0.0-20161219230853-39f87cc3b432/go.mod"
	...
	"github.com/google/cel-go v0.12.4/go.mod"
	...
	"github.com/hashicorp/vault/api v1.3.0/go.mod"
	"github.com/hashicorp/vault/api v1.3.1/go.mod"
	"github.com/hashicorp/vault/api/auth/approle v0.1.1/go.mod"
	"github.com/hashicorp/vault/api/auth/kubernetes v0.1.0/go.mod"
	...
	"github.com/lucas-clemente/quic-go v0.28.2-0.20220813150001-9957668d4301/go.mod"
	...
	"github.com/nbrownus/go-metrics-prometheus v0.0.0-20210712211119-974a6260965f/go.mod"
	...
	"github.com/slackhq/nebula v1.5.2/go.mod"
	...
	"github.com/smallstep/certificates v0.21.0/go.mod"
	"github.com/smallstep/cli v0.21.0"
	"github.com/smallstep/cli v0.21.0/go.mod"
	"github.com/smallstep/nosql v0.4.0"
	"github.com/smallstep/nosql v0.4.0/go.mod"
	"github.com/smallstep/truststore v0.12.0"
	"github.com/smallstep/truststore v0.12.0/go.mod"
	...
	"github.com/tailscale/tscert v0.0.0-20220316030059-54bbcb9f74e2/go.mod"
	...
	"github.com/yuin/goldmark v1.4.5/go.mod"
	"github.com/yuin/goldmark v1.4.13"
	"github.com/yuin/goldmark v1.4.13/go.mod"
	"github.com/yuin/goldmark-highlighting v0.0.0-20220208100518-594be1970594"
	"github.com/yuin/goldmark-highlighting v0.0.0-20220208100518-594be1970594/go.mod"
	...
	"go.opentelemetry.io/contrib/instrumentation/net/http/otelhttp v0.34.0/go.mod"
	...
	"go.opentelemetry.io/otel/exporters/otlp/internal/retry v1.4.0/go.mod"
	"go.opentelemetry.io/otel/exporters/otlp/otlptrace v1.4.0"
	"go.opentelemetry.io/otel/exporters/otlp/otlptrace v1.4.0/go.mod"
	"go.opentelemetry.io/otel/exporters/otlp/otlptrace/otlptracegrpc v1.4.0"
	"go.opentelemetry.io/otel/exporters/otlp/otlptrace/otlptracegrpc v1.4.0/go.mod"
	"go.opentelemetry.io/otel/metric v0.31.0"
	"go.opentelemetry.io/otel/metric v0.31.0/go.mod"
	"go.opentelemetry.io/otel/sdk v1.4.0"
	"go.opentelemetry.io/otel/sdk v1.4.0/go.mod"
	...
	"go.step.sm/cli-utils v0.7.0/go.mod"
	"go.step.sm/cli-utils v0.7.3"
	"go.step.sm/cli-utils v0.7.3/go.mod"
	"go.step.sm/crypto v0.9.0/go.mod"
	"go.step.sm/crypto v0.16.2"
	"go.step.sm/crypto v0.16.2/go.mod"
	"go.step.sm/linkedca v0.16.1"
	"go.step.sm/linkedca v0.16.1/go.mod"
	...
	"golang.org/x/net v0.0.0-20220812165438-1d4ff48094d1/go.mod"
	...
	"golang.zx2c4.com/wireguard/windows v0.5.1/go.mod"
...
SRC_URI="https://github.com/caddyserver/caddy/archive/v2.6.1.tar.gz -> caddy-v2.6.1.tar.gz
	${EGO_SUM_SRC_URI}"
