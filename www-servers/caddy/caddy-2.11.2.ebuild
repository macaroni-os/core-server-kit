...
SRC_URI="
https://api.github.com/repos/caddyserver/caddy/tarball/v2.11.2 -> caddy-2.11.2-ffb6ab0.tar.gz
mirror://macaroni/caddy-2.11.2-mark-go-bundle-ffb6ab0.tar.xz -> caddy-2.11.2-mark-go-bundle-ffb6ab0.tar.xz"
LICENSE="Apache-2.0"
SLOT="0"
KEYWORDS="*"
BDEPEND="dev-lang/go
...
src_compile() {
	go build -ldflags '-X github.com/caddyserver/caddy/v2.CustomVersion=v2.11.2-ffb6ab0-macaroni' \
