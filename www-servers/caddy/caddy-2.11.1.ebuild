...
SRC_URI="
https://api.github.com/repos/caddyserver/caddy/tarball/v2.11.1 -> caddy-2.11.1-6610e2f.tar.gz
mirror://macaroni/caddy-2.11.1-mark-go-bundle-6610e2f.tar.xz -> caddy-2.11.1-mark-go-bundle-6610e2f.tar.xz"
LICENSE="Apache-2.0"
SLOT="0"
KEYWORDS="*"
BDEPEND="dev-lang/go
...
src_compile() {
	go build -ldflags '-X github.com/caddyserver/caddy/v2.CustomVersion=v2.11.1-6610e2f-macaroni' \
