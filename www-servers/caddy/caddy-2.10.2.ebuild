...
SRC_URI="
https://api.github.com/repos/caddyserver/caddy/tarball/v2.10.2 -> caddy-2.10.2-551f793.tar.gz
mirror://macaroni/caddy-2.10.2-mark-go-bundle-551f793.tar.xz -> caddy-2.10.2-mark-go-bundle-551f793.tar.xz"
LICENSE="Apache-2.0"
SLOT="0"
KEYWORDS="*"
BDEPEND="dev-lang/go
...
src_compile() {
	go build -ldflags '-X github.com/caddyserver/caddy/v2.CustomVersion=v2.10.2-551f793-macaroni' \
