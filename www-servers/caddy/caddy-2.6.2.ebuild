...
EGO_SUM=(
	...
	"github.com/google/cel-go v0.12.5/go.mod"
	...
	"github.com/smallstep/certificates v0.22.1/go.mod"
	"github.com/smallstep/cli v0.22.0"
	"github.com/smallstep/cli v0.22.0/go.mod"
	...
	"go.step.sm/cli-utils v0.7.4/go.mod"
	"go.step.sm/crypto v0.9.0/go.mod"
	"go.step.sm/crypto v0.18.0"
	"go.step.sm/crypto v0.18.0/go.mod"
	"go.step.sm/linkedca v0.18.0"
	"go.step.sm/linkedca v0.18.0/go.mod"
...
SRC_URI="https://github.com/caddyserver/caddy/archive/v2.6.2.tar.gz -> caddy-v2.6.2.tar.gz
	${EGO_SUM_SRC_URI}"
