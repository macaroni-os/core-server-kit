...
SRC_URI="
https://api.github.com/repos/garethgeorge/backrest/tarball/v1.12.1 -> backrest-1.12.1-9dd08d0.tar.gz
mirror://macaroni/backrest-1.12.1-mark-go-bundle-9dd08d0.tar.xz -> backrest-1.12.1-mark-go-bundle-9dd08d0.tar.xz"
LICENSE="GPL-3.0"
SLOT="0"
KEYWORDS="*"
IUSE="systemd"
...
src_compile() {
	...
	npm install . || die
	popd 2>&1 >/dev/null
	GOOS=linux BACKREST_BUILD_VERSION=1.12.1 \
	  go generate ./...
	CGO_ENABLED=0 \
	  go build \
	  -asmflags "-trimpath=${S}" \
