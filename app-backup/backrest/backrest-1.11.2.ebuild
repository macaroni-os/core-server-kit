...
SRC_URI="
https://api.github.com/repos/garethgeorge/backrest/tarball/v1.11.2 -> backrest-1.11.2-4357723.tar.gz
mirror://macaroni/backrest-1.11.2-mark-go-bundle-4357723.tar.xz -> backrest-1.11.2-mark-go-bundle-4357723.tar.xz"
LICENSE="GPL-3.0"
SLOT="0"
KEYWORDS="*"
IUSE="systemd"
...
src_compile() {
	...
	npm install . || die
	popd 2>&1 >/dev/null
	GOOS=linux BACKREST_BUILD_VERSION=1.11.2 \
	  go generate ./...
	CGO_ENABLED=0 \
	  go build \
	  -asmflags "-trimpath=${S}" \
