...
SRC_URI="https://github.com/restic/restic/tarball/6862b4e9b52748cc206d1f5577809a477e4ddb4b -> restic-0.16.5-6862b4e.tar.gz
https://direct.funtoo.org/b1/cc/d4/b1ccd41dd5fcad18f4eadf76d636b13fc53c645e689b3ce0de13049b7595756a47af0c619133930b010d9fcc86a97e0df22ab48cb885e18883313dd5168f9211 -> restic-0.16.5-funtoo-go-bundle-53d98428de990e5c01a62ef7ba1d350246ff5bccc4aa20c83aa87b3474c0be12c11040442048a9a42652697ebf7da733ae746c91766d23942cf2a40a2a9487c2.tar.gz"
...
src_compile() {
	go build -ldflags '-X main.version=0.16.5' \
		-asmflags "-trimpath=${S}" \
		-gcflags "-trimpath=${S}" \
		-o restic ./cmd/restic
}
