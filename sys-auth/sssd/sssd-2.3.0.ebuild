...
inherit autotools flag-o-matic linux-info multilib-minimal pam python-r1 toolchain-funcs

DESCRIPTION="System Security Services Daemon provides access to identity and authentication"
HOMEPAGE="https://pagure.io/SSSD/sssd"
SRC_URI="https://github.com/SSSD/sssd/releases/download/sssd-2_3_0/sssd-2.3.0.tar.gz -> sssd-2.3.0.tar.gz"
KEYWORDS="*"
