...
SRC_URI="
	amd64? ( https://artifacts.elastic.co/downloads/elasticsearch/elasticsearch-7.17.7-linux-x86_64.tar.gz -> elasticsearch-7.17.7-linux-x86_64.tar.gz )

	arm64? ( https://artifacts.elastic.co/downloads/elasticsearch/elasticsearch-7.17.7-linux-aarch64.tar.gz -> elasticsearch-7.17.7-linux-aarch64.tar.gz )
"
