...
SRC_URI="
	amd64? ( https://artifacts.elastic.co/downloads/elasticsearch/elasticsearch-8.6.1-linux-x86_64.tar.gz -> elasticsearch-8.6.1-linux-x86_64.tar.gz )

	arm64? ( https://artifacts.elastic.co/downloads/elasticsearch/elasticsearch-8.6.1-linux-aarch64.tar.gz -> elasticsearch-8.6.1-linux-aarch64.tar.gz )
"
