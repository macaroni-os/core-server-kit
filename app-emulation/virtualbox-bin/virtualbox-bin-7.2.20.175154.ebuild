...
SRC_URI="
https://download.virtualbox.org/virtualbox/7.2.20/VirtualBox-7.2.20-175154-Linux_amd64.run -> virtualbox-bin-7.2.20.175154-Linux_amd64.run
https://download.virtualbox.org/virtualbox/7.2.20/Oracle_VirtualBox_Extension_Pack-7.2.20-175154.vbox-extpack -> virtualbox-bin-7.2.20.175154-oracle-extension_pack.tar.gz
sdk? ( https://download.virtualbox.org/virtualbox/7.2.20/VirtualBoxSDK-7.2.20-175154.zip -> virtualbox-bin-7.2.20.175154-sdk.zip )"
LICENSE="GPL-2 PUEL"
SLOT="0"
KEYWORDS="*"
...
"
PDEPEND="~app-emulation/virtualbox-modules-7.2.20.175154
...
src_unpack() {
	unpack_makeself virtualbox-bin-7.2.20.175154-Linux_amd64.run
	unpack ./VirtualBox.tar.bz2

	mkdir "${S}"/Oracle_VM_VirtualBox_Extension_Pack || die
	pushd "${S}"/Oracle_VM_VirtualBox_Extension_Pack &>/dev/null || die
	unpack virtualbox-bin-7.2.20.175154-oracle-extension_pack.tar.gz
	popd &>/dev/null || die

	if use sdk ; then
		unpack virtualbox-bin-7.2.20.175154-sdk.zip
	fi
}
src_configure() {
	:;
