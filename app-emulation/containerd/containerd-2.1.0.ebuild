...
SRC_URI="https://github.com/containerd/containerd/tarball/061792f0ecf3684fb30a3a0eb006799b8c6638a7 -> containerd-2.1.0-061792f.tar.gz"
...
src_compile() {
	...
	myemakeargs=(
		...
		REVISION="061792f0ecf3684fb30a3a0eb006799b8c6638a7"
		VERSION=v${PV}
	)
