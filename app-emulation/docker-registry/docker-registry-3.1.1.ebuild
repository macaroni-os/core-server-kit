...
SRC_URI="https://api.github.com/repos/distribution/distribution/tarball/v3.1.1 -> docker-registry-3.1.1-9a8d98b.tar.gz"
LICENSE="Apache-2.0"
SLOT="0"
KEYWORDS="*"
IUSE="systemd"
...
src_prepare() {
	...
	sed -i -e "s/git describe.*/echo ${PV})/"\
	  -e "s/git rev-parse.*/echo 9a8d98b679740cd514aa7e7d84d23d442a5ef54c)/"\
