...
SRC_URI="https://api.github.com/repos/distribution/distribution/tarball/v3.1.2 -> docker-registry-3.1.2-3220848.tar.gz"
LICENSE="Apache-2.0"
SLOT="0"
KEYWORDS="*"
IUSE="systemd"
...
src_prepare() {
	...
	sed -i -e "s/git describe.*/echo ${PV})/"\
	  -e "s/git rev-parse.*/echo 3220848f15d9279c66a41aa0a257469e6aede1e9)/"\
