...
SRC_URI="https://api.github.com/repos/distribution/distribution/tarball/v3.1.0 -> docker-registry-3.1.0-708f8d6.tar.gz"
LICENSE="Apache-2.0"
SLOT="0"
KEYWORDS="*"
IUSE="systemd"
...
src_prepare() {
	...
	sed -i -e "s/git describe.*/echo ${PV})/"\
	  -e "s/git rev-parse.*/echo 708f8d6b060248fe7192294dd5440320ffc86da0)/"\
