...
SRC_URI="https://api.github.com/repos/moby/moby/tarball/docker-v29.5.0 -> docker-29.5.0-ff8d90a.tar.gz"
LICENSE="Apache-2.0"
SLOT="0"
KEYWORDS="*"
...
src_compile() {
	export DOCKER_GITCOMMIT="ff8d90a"
	export GOPATH="${WORKDIR}/${P}"
	export VERSION="29.5.0-macaroni"
