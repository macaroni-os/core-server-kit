...
SRC_URI="https://api.github.com/repos/moby/moby/tarball/docker-v29.7.2 -> docker-29.7.2-6a43e3d.tar.gz"
LICENSE="Apache-2.0"
SLOT="0"
KEYWORDS="*"
...
src_compile() {
	export DOCKER_GITCOMMIT="6a43e3d"
	export GOPATH="${WORKDIR}/${P}"
	export VERSION="29.7.2-macaroni"
