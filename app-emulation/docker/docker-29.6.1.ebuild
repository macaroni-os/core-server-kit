...
SRC_URI="https://api.github.com/repos/moby/moby/tarball/docker-v29.6.1 -> docker-29.6.1-8ec5ab3.tar.gz"
LICENSE="Apache-2.0"
SLOT="0"
KEYWORDS="*"
...
src_compile() {
	export DOCKER_GITCOMMIT="8ec5ab3"
	export GOPATH="${WORKDIR}/${P}"
	export VERSION="29.6.1-macaroni"
