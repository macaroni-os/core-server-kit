...
SRC_URI="https://api.github.com/repos/moby/moby/tarball/docker-v29.7.1 -> docker-29.7.1-c5b8ce9.tar.gz"
LICENSE="Apache-2.0"
SLOT="0"
KEYWORDS="*"
...
src_compile() {
	export DOCKER_GITCOMMIT="c5b8ce9"
	export GOPATH="${WORKDIR}/${P}"
	export VERSION="29.7.1-macaroni"
