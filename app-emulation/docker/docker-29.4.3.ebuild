...
SRC_URI="https://api.github.com/repos/moby/moby/tarball/docker-v29.4.3 -> docker-29.4.3-56be731.tar.gz"
LICENSE="Apache-2.0"
SLOT="0"
KEYWORDS="*"
...
src_compile() {
	export DOCKER_GITCOMMIT="56be731"
	export GOPATH="${WORKDIR}/${P}"
	export VERSION="29.4.3-macaroni"
