...
SRC_URI="https://api.github.com/repos/moby/moby/tarball/docker-v29.4.0 -> docker-29.4.0-daa0cb7.tar.gz"
LICENSE="Apache-2.0"
SLOT="0"
KEYWORDS="*"
...
src_compile() {
	export DOCKER_GITCOMMIT="daa0cb7"
	export GOPATH="${WORKDIR}/${P}"
	export VERSION="29.4.0-macaroni"
