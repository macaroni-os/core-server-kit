...
SRC_URI="https://api.github.com/repos/moby/moby/tarball/docker-v29.7.0 -> docker-29.7.0-4b5cb71.tar.gz"
LICENSE="Apache-2.0"
SLOT="0"
KEYWORDS="*"
...
src_compile() {
	export DOCKER_GITCOMMIT="4b5cb71"
	export GOPATH="${WORKDIR}/${P}"
	export VERSION="29.7.0-macaroni"
