...
SRC_URI="https://api.github.com/repos/moby/moby/tarball/docker-v29.3.1 -> docker-29.3.1-f78c987.tar.gz"
LICENSE="Apache-2.0"
SLOT="0"
KEYWORDS="*"
...
src_compile() {
	export DOCKER_GITCOMMIT="f78c987"
	export GOPATH="${WORKDIR}/${P}"
	export VERSION="29.3.1-macaroni"
