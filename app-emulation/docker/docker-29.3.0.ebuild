...
SRC_URI="https://api.github.com/repos/moby/moby/tarball/docker-v29.3.0 -> docker-29.3.0-83bca51.tar.gz"
LICENSE="Apache-2.0"
SLOT="0"
KEYWORDS="*"
...
src_compile() {
	export DOCKER_GITCOMMIT="83bca51"
	export GOPATH="${WORKDIR}/${P}"
	export VERSION="29.3.0-macaroni"
