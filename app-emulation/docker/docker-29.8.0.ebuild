...
SRC_URI="https://api.github.com/repos/moby/moby/tarball/docker-v29.8.0 -> docker-29.8.0-3ce5872.tar.gz"
LICENSE="Apache-2.0"
SLOT="0"
KEYWORDS="*"
...
src_compile() {
	export DOCKER_GITCOMMIT="3ce5872"
	export GOPATH="${WORKDIR}/${P}"
	export VERSION="29.8.0-macaroni"
