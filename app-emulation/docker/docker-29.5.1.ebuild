...
SRC_URI="https://api.github.com/repos/moby/moby/tarball/docker-v29.5.1 -> docker-29.5.1-dd24a3a.tar.gz"
LICENSE="Apache-2.0"
SLOT="0"
KEYWORDS="*"
...
src_compile() {
	export DOCKER_GITCOMMIT="dd24a3a"
	export GOPATH="${WORKDIR}/${P}"
	export VERSION="29.5.1-macaroni"
