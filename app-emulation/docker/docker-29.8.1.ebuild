...
SRC_URI="https://api.github.com/repos/moby/moby/tarball/docker-v29.8.1 -> docker-29.8.1-464cd50.tar.gz"
LICENSE="Apache-2.0"
SLOT="0"
KEYWORDS="*"
...
src_compile() {
	export DOCKER_GITCOMMIT="464cd50"
	export GOPATH="${WORKDIR}/${P}"
	export VERSION="29.8.1-macaroni"
