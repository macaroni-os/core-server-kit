...
SRC_URI="https://api.github.com/repos/moby/moby/tarball/docker-v29.4.2 -> docker-29.4.2-d329809.tar.gz"
LICENSE="Apache-2.0"
SLOT="0"
KEYWORDS="*"
...
src_compile() {
	export DOCKER_GITCOMMIT="d329809"
	export GOPATH="${WORKDIR}/${P}"
	export VERSION="29.4.2-macaroni"
