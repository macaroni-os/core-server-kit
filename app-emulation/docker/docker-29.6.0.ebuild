...
SRC_URI="https://api.github.com/repos/moby/moby/tarball/docker-v29.6.0 -> docker-29.6.0-70eaf5e.tar.gz"
LICENSE="Apache-2.0"
SLOT="0"
KEYWORDS="*"
...
src_compile() {
	export DOCKER_GITCOMMIT="70eaf5e"
	export GOPATH="${WORKDIR}/${P}"
	export VERSION="29.6.0-macaroni"
