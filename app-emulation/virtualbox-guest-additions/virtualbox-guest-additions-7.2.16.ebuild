...
DESCRIPTION="VirtualBox kernel modules and user-space tools for MacaroniOS guests"
HOMEPAGE="https://www.virtualbox.org/"
SRC_URI="https://download.virtualbox.org/virtualbox/7.2.16/VirtualBox-7.2.16.tar.bz2 -> virtualbox-guest-additions-7.2.16.tar.bz2"
...
"
PDEPEND="X? ( x11-drivers/xf86-video-vbox )
	
"
S=""${WORKDIR}"/VirtualBox-7.2.16"
BUILD_TARGETS="all"
BUILD_TARGET_ARCH="${ARCH}"

VBOX_MOD_SRC_DIR="${S}/out/linux.${ARCH}/release/bin/additions/src"
MODULESD_VBOXSF_ALIASES=("fs-vboxsf vboxsf")
...
src_prepare() {
	# Remove shipped binaries (kBuild,yasm)
...
src_compile() {
	...
	local myemakeargs=(
		VBOX_BUILD_PUBLISHER=_Macaroni
