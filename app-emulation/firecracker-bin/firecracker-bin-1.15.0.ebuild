...
SRC_URI="
amd64? ( https://github.com/firecracker-microvm/firecracker/releases/download/v1.15.0/firecracker-v1.15.0-x86_64.tgz -> firecracker-bin-1.15.0-7db02ad-x86_64.tgz )
arm64? ( https://github.com/firecracker-microvm/firecracker/releases/download/v1.15.0/firecracker-v1.15.0-aarch64.tgz -> firecracker-bin-1.15.0-7db02ad-aarch64.tgz )"
LICENSE="Apache-2.0"
SLOT="0"
KEYWORDS="*"
IUSE="amd64 arm64"
...
src_install() {
	...
	newbin "${WORKDIR}/release-v1.15.0-${my_arch}/firecracker-v${PV}-${my_arch}" firecracker
	newbin "${WORKDIR}/release-v1.15.0-${my_arch}/jailer-v${PV}-${my_arch}" jailer
}
pkg_postinst() {
	elog
