...
SRC_URI="
amd64? ( https://dl.grafana.com/oss/release/grafana-12.0.2.linux-amd64.tar.gz -> grafana-bin-12.0.2.linux-amd64.tar.gz )
arm64? ( https://dl.grafana.com/oss/release/grafana-12.0.2.linux-arm64.tar.gz -> grafana-bin-12.0.2.linux-arm64.tar.gz )"
LICENSE="AGPL-3"
SLOT="0"
KEYWORDS="*"
IUSE="amd64 arm64"
