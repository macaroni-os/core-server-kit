...
SRC_URI="
	amd64? ( https://artifacts.elastic.co/downloads/kibana/kibana-7.17.5-linux-x86_64.tar.gz )
	arm64? ( https://artifacts.elastic.co/downloads/kibana/kibana-7.17.5-linux-aarch64.tar.gz )
"
