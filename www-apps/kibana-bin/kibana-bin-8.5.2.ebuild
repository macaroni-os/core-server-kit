...
SRC_URI="
	amd64? ( https://artifacts.elastic.co/downloads/kibana/kibana-8.5.2-linux-x86_64.tar.gz -> kibana-8.5.2-linux-x86_64.tar.gz )
	arm64? ( https://artifacts.elastic.co/downloads/kibana/kibana-8.5.2-linux-aarch64.tar.gz -> kibana-8.5.2-linux-aarch64.tar.gz )
"
