...
SRC_URI="
	amd64? ( https://artifacts.elastic.co/downloads/kibana/kibana-7.17.10-linux-x86_64.tar.gz -> kibana-7.17.10-linux-x86_64.tar.gz )
	arm64? ( https://artifacts.elastic.co/downloads/kibana/kibana-7.17.10-linux-aarch64.tar.gz -> kibana-7.17.10-linux-aarch64.tar.gz )
"
