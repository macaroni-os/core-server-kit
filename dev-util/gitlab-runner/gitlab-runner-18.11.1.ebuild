...
SRC_URI="
https://gitlab.com/gitlab-org/gitlab-runner/-/archive/v18.11.1/gitlab-runner-v18.11.1.tar.bz2 -> gitlab-runner-18.11.1.tar.bz2
mirror://macaroni/gitlab-runner-18.11.1-mark-go-bundle.tar.xz -> gitlab-runner-18.11.1-mark-go-bundle.tar.xz"
LICENSE="MIT"
SLOT="0"
KEYWORDS="*"
DOCS=(
...
"
S="${WORKDIR}/gitlab-runner-v18.11.1"
pkg_setup() {
