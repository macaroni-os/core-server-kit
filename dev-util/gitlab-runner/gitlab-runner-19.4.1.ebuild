...
SRC_URI="
https://gitlab.com/gitlab-org/gitlab-runner/-/archive/v19.4.1/gitlab-runner-v19.4.1.tar.bz2 -> gitlab-runner-19.4.1.tar.bz2
mirror://macaroni/gitlab-runner-19.4.1-mark-go-bundle.tar.xz -> gitlab-runner-19.4.1-mark-go-bundle.tar.xz"
LICENSE="MIT"
SLOT="0"
KEYWORDS="*"
DOCS=(
...
"
S="${WORKDIR}/gitlab-runner-v19.4.1"
pkg_setup() {
