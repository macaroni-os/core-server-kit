...
SRC_URI="
https://gitlab.com/gitlab-org/gitlab-runner/-/archive/v18.11.3/gitlab-runner-v18.11.3.tar.bz2 -> gitlab-runner-18.11.3.tar.bz2
mirror://macaroni/gitlab-runner-18.11.3-mark-go-bundle.tar.xz -> gitlab-runner-18.11.3-mark-go-bundle.tar.xz"
LICENSE="MIT"
SLOT="0"
KEYWORDS="*"
DOCS=(
...
"
S="${WORKDIR}/gitlab-runner-v18.11.3"
pkg_setup() {
