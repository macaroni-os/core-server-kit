...
SRC_URI="
https://gitlab.com/gitlab-org/gitlab-runner/-/archive/v19.3.2/gitlab-runner-v19.3.2.tar.bz2 -> gitlab-runner-19.3.2.tar.bz2
mirror://macaroni/gitlab-runner-19.3.2-mark-go-bundle.tar.xz -> gitlab-runner-19.3.2-mark-go-bundle.tar.xz"
LICENSE="MIT"
SLOT="0"
KEYWORDS="*"
DOCS=(
...
"
S="${WORKDIR}/gitlab-runner-v19.3.2"
pkg_setup() {
